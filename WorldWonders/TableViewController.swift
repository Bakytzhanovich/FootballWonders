...
class TableViewController: UITableViewController {
    ...
    var arrayWonders = [FootballWonder]()
...
//        let wonder = FootballWonder(teamName: "test", league: "test", location: "test", flag: "test", picture: "test")
...
//        tableView.reloadData()
    ...
    func loadData() {
        ...
        AF.request("https://demo2894736.mockable.io/getFootball", method:
                .get).responseJSON{responce in
            ...
            if responce.response?.statusCode == 200{
                ...
                if let resultArray = json.array{
                    for item in resultArray{
                        let wonderItem = FootballWonder(json: item)
